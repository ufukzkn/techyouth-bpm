...
- Admin-only user approval/role controls live in the dedicated `Kullanicilar / Roller` route with search, status filtering, pagination and a selected-user detail/history panel.
