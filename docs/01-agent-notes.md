...
- Latest verified backend baseline is 84 passing tests. It covers community-code registration and `Atanmadi` membership, SuperAdmin boundaries, community isolation, role reassignment, deterministic seed behavior, notification ownership, audit scope, deactivated-community access, dashboard scope and audit sorting.
