...
- Restored API sessions are verified once through `/api/auth/me`.
- Expired or unauthorized sessions return to login with a visible notice.
...
- The top bar and settings screen show session expiry information.
