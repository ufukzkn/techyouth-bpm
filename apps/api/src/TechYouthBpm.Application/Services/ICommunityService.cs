...
public interface ICommunityService
{
    ...
    Task<Result<CommunityDto>> RegenerateInviteCodeAsync(Guid communityId, UserDto currentUser, CancellationToken cancellationToken = default);
    Task<Result<CommunitySummaryDto>> GetSummaryAsync(Guid communityId, UserDto currentUser, CancellationToken cancellationToken = default);
    ...
    Task<Result> DeleteRoleAsync(Guid communityId, Guid roleId, DeleteCommunityRoleRequest request, UserDto currentUser, CancellationToken cancellationToken = default);
