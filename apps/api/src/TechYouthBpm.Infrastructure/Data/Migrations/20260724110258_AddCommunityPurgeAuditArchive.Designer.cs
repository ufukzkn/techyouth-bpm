...
namespace TechYouthBpm.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260724110258_AddCommunityPurgeAuditArchive")]
    partial class AddCommunityPurgeAuditArchive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechYouthBpm.Domain.Entities.ArchivedAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CommunityDeletionArchiveId")
                        .HasColumnType("uuid");

                    b.Property<string>("CommunityRoleName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("EntityUsername")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("CommunityDeletionArchiveId", "Category", "OccurredAt");

                    b.ToTable("ArchivedAuditEvents");
                });
            ...
            modelBuilder.Entity("TechYouthBpm.Domain.Entities.CommunityDeletionArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CommunityRoleCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("OriginalCommunityId")
                        .HasColumnType("uuid");

                    b.Property<int>("PreservedUserCount")
                        .HasColumnType("integer");

                    b.Property<int>("ProcessCount")
                        .HasColumnType("integer");

                    b.Property<int>("ProcessStepCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SystemAuditCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OriginalCommunityId");

                    b.ToTable("CommunityDeletionArchives");
                });
            ...
            modelBuilder.Entity("TechYouthBpm.Domain.Entities.ArchivedAuditEvent", b =>
                {
                    b.HasOne("TechYouthBpm.Domain.Entities.CommunityDeletionArchive", "CommunityDeletionArchive")
                        .WithMany("Events")
                        .HasForeignKey("CommunityDeletionArchiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CommunityDeletionArchive");
                });
