...
export const demoUsers: Array<{
  ...
  { username: "fatih.terim", password: "imparator123", displayName: "Fatih Terim", role: "User", community: "sport", communityRoleId: "20202020-0000-0000-0000-000000000001", communityRoleName: "Topluluk Admin", permissions: ["Community.ManageUsers", "Community.ManageRoles", "Community.ManageAdmins", "Teams.View", "Teams.Manage", "Forms.View", "Forms.Create", "Forms.Update", "Workflows.View", "Workflows.Create", "Workflows.Update", "Workflows.Publish", "Processes.View", "Processes.ViewAll", "Processes.Start", "Tasks.View", "Tasks.Act", "Tasks.ManageAll", "Audit.View"] },
  ...
  return {
    ...
    user: {
      ...
      permissions: user.role === "SuperAdmin"
        ? ["Community.ManageUsers", "Community.ManageRoles", "Community.ManageAdmins", "Teams.View", "Teams.Manage", "Forms.View", "Forms.Create", "Forms.Update", "Workflows.View", "Workflows.Create", "Workflows.Update", "Workflows.Publish", "Processes.View", "Processes.ViewAll", "Processes.Start", "Tasks.View", "Tasks.Act", "Tasks.ManageAll", "Audit.View"]
        : user.permissions ?? [],
