    ...
    : action.type === "update"
      ...
      : action.type === "add"
        ...
        : action.type === "toggle-lead"
          ? [isTr ? "Sorumluluğu güncelle" : "Update lead", action.member.isLead ? (isTr ? "Kullanıcının takım sorumluluğu kaldırılacak; diğer yetkileri değişmeyecek." : "Team lead status will be removed; other permissions stay unchanged.") : (isTr ? "Kullanıcı takım sorumlusu olarak işaretlenecek ve yalnız sorumlulara açılan takım görevlerini üstlenebilecek. Global izinleri değişmeyecek." : "The user will become a team lead and can claim team tasks restricted to leads. Global permissions will not change."), isTr ? "Uygula" : "Apply"]
