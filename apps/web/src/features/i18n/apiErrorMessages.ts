...
const apiErrorKeys: Record<string, TranslationKey> = {
  ...
  "A process definition with this name already exists in the community.": "api.error.processDefinitionNameExists",
  "Community role name is already used.": "api.error.communityRoleNameExists",
  "System community roles cannot be edited.": "api.error.systemCommunityRoleImmutable",
  "This action can only be performed by a team lead. Contact your team lead.": "api.error.teamLeadRequired",
